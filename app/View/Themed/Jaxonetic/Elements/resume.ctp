<div id="resume">
<!-- the pdf won't generate without this 'div align="center"' -->
	<div align="center"  id="contact-info" class="section">
	    <ul class="jax-center-aligned list-unstyled"><li>Alonzo L. Jackson II</li>
	        <li>Largo  Santo Antonio Alem do Carmo, 12</li>
	        <li>Salvador, Bahia Brasil</li>
	        <li>jaxonetic@gmail.com</li>
	    </ul>	
	</div>
	...
	<div id="computer-skills"  class="section">
		...
		<div class="work-info">
			...
			<dl>
				...
				<dd>
					<ul>
						<li>
							Maintained and updated Compucredit's Purposecard website which was run on Jboss under the Struts Framework using Velocity templates.  Most of the webservices, however, were written in C# and I maintained, updated, and implemented those as well.
						</li>
						<li>
